...
\begin{example}
    ...
    \begin{enumerate}[label=(\arabic*)]
        ...
        \vspace{80pt}
        \item Derive the Marshall-Lerner condition for this economy. You should be albe to write it as a lower bound for $NX$. Interpret this result.
        \vspace{80pt}
        \item Show that under certain parametric restriction, if $m_1 < x_1$, then a depreciation induces an increase in equilibrium output. Interpret this result.
        \vspace{80pt}
    \end{enumerate}
\end{example}
