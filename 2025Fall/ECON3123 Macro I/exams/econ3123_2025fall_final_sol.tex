...
\begin{enumerate}[label=(\arabic*)]
    ...
    \item (10 points) Inflation decreases. Output remains unchanged. No policy, no change in output. The equilibrium point does not change so that $\pi_{t+2}-\pi_{t+1}<0$ which causes continuous disinflation.
