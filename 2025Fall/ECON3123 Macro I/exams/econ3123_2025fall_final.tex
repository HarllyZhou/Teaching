...
\noindent\textbf{Question 1: Yield curve and bond pricing (12 points)}
...
\begin{enumerate}[label=(\arabic*)]
    \item (3 points) Using the no-arbitrage argument, derive $i_2^e$ by considering arbitrage opportunities between 2-year bond and 3-year bond. (Hint: Consider log approximation.)
    ...
    \item (3 points) Do you predict that this economy will experience a boom or a recession from the yield curve? Explain your answer.
\end{enumerate}
...
\newpage
\noindent\textbf{Question 3: Fixed exchange rate regime (25 points)}
...
\begin{enumerate}[label=(\arabic*),resume]
    \item (6 points) Calculate the domestic nominal interest rate that the central bank should target to maintain the fixed exchange rate regime. Can this nominal interest rate be targeted?
    \item (8 points) Can the central bank still maintain fixed exchange rate regime? Draw in the same diagram to explain your answer. If you shift any curve, label the new curve with subscript $C$. 
\end{enumerate}
