...
\subparagraph{Interest Rate} Consider ta one-year zero-coupon risk-free bond with face value \$100. Suppose you invest $\$ P_B$ now. The rate of return of this bond is the interest rate:
\begin{align*}
...
\begin{align*}
	M^D = \$ Y L(i)
\end{align*}
where $L(i)$ is a \textbf{decreasing} function of interest rate $i$. 
...
\begin{example}
	Consider a zero-coupon bond with 3-year time-to-maturity with face value \$ 1000. If the bond price is \$ 850, what is the interest rate?
\end{example}
