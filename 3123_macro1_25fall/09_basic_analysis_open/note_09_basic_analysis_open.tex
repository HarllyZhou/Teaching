...
\begin{example}
    ...
    \end{enumerate}
\end{example}
You can see that there will be arbitrage opportunity if the real exchange rate is not 1. This motivates another international parity condition: \textbf{purchasing power parity} (PPP). 
...
\begin{example}
    ...
    \begin{enumerate}[label=(\arabic*)]
        ...
        \vspace{60pt}
        \item Derive the general Marshall-Lerner condition.
        \vspace{80pt}
        \item Show that under the general Marshall-Lerner condition, then $m_1 < x_1$.
        \vspace{60pt}
        \item Show that $NX > -m_2$ if and only if $m_1 < x_1$. Interpret the two conditions.
        \vspace{60pt}
    \end{enumerate}
\end{example}
...
\begin{example}
    ...
    \begin{enumerate}[label=(\arabic*)]
        ...
        \vspace{60pt}
        \item Suppose that the depreciation rate is 0.5\%. As a result, in the new equilibrium, the domestic import decreases by 2\% and the export increases by 3\%. In the initial equilibrium, the ratio between export and import in terms of domestic goods is 2. Use the general Marshall-Lerner condition result from the last example, examine whether this shock and the effect satisfy the condition.
        \vspace{60pt}
...
\begin{example}[DIFFICULT!!! Two-Country Model with Home Bias]
    ...
    \begin{enumerate}[label=(\roman*)]
        ...
        \vspace{60pt}
        \item Suppose that $\epsilon$ changes to $\epsilon'=0.8$ now. Compute the new equilibria output in the domestic and foreign economy. Does the result match your result in the previous part?
        \vspace{60pt}
        \item Back to when $\epsilon = 1$. Suppose that $\lambda$ changes to $\lambda' = 0.5$ now, $\lambda^*$ remaining unchanged. Compute the new equilibria output in the domestic and foreign economy. How to interpret the result? 
    \end{enumerate}
    \end{enumerate}
\end{example}
