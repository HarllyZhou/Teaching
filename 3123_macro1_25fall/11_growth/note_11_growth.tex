...
\begin{exercise}
    Show that at the steady state, capital per worker $\frac{K}{N}$ and output per worker $\frac{Y}{N}$ grow at the rate $g_A$. And equivalently, the aggregate level of capital $K$ and aggregate level of output $Y$ grow at the rate $g_A + g_N$.
\end{exercise}
