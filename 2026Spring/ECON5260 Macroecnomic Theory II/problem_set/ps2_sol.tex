...
\begin{enumerate}[label=\arabic*.]
    ...
    \end{align*}
    When $i_{t-1} > 0$, CIA constraint is binding, that is $\mu_t > 0$. To reflect a higher marginal cost for $C^m$ relative to $C^c$, that is, $1+i_{t-1}$ vs 1, at optimum, marginal benefit for $C^m$ should be proportionally higher than that for $C^c$. (12 points)
